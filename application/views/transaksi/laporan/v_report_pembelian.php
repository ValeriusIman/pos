    ...
    <div class="col-12">
        <div class="card">
            <div class="row">
                <div class="col-sm-6">
                    <div class="card-body">
                        <form id="tanggal-transaksi" method="POST" action="<?= base_url('pembelian/downloadReport') ?>">
...
<script>
    $(function() {
        var data = $("#data-pembelian").DataTable({
            "responsive": true,
            "autoWidth": false
        });
        ...
        $('#btn-tanggal').on('click', function(event) {
            ...
            if (awal > akhir) {
                ...
                $.ajax({
                    url: "<?= base_url('pembelian/getReport') ?>",
                    type: "post",
                    data: {
                        tanggal_awal: awal,
                        tanggal_akhir: akhir,
