    ...
    <div class="col-12">
        ...
        <div class="invoice p-3 mb-3">
            ...
            <div class="row no-print">
                <div class="col-12">
                    <a href="<?= base_url('transaksi/print/') . $transaksi->transaksi_id ?>" target="_blank" class="btn btn-success"><i class="fas fa-print"></i> Print</a>
                    <a href="<?= base_url('transaksi') ?>" class="btn btn-primary"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>
                </div>
            </div>
        </div>
        <!-- /.invoice -->
